...
% meta-eata
\title{重庆邮电大学 Beamer 模板}
\subtitle{CQUPT Beamer Template}
\topic{XXX Presentation}
\author{张三}
\sid{学号}
\advisor{李四 教授}
\date{\today}
        ...
        \begin{columns}
            \begin{column}{0.7\textwidth}
                \begin{block}{Code for Adding Images}
                    \begin{lstlisting}[language=TeX, gobble=20]
                        \usepackage{graphicx}
                            % ...
                        \includegraphics[width=\textwidth]{gallery/demo.jpg}
                    \end{lstlisting}
                \end{block}
            \end{column}
            \begin{column}{0.3\textwidth}
                \vskip5pt\includegraphics[width=\textwidth]{assets/imgs/demo.jpg}
            \end{column}
        \end{columns}
    \end{frame}
